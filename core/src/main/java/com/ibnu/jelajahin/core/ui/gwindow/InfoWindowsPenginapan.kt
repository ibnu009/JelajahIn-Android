...
class InfoWindowsPenginapan(private val activity: Activity, private val context: Context) : GoogleMap.InfoWindowAdapter {
    ...
    override fun getInfoContents(p0: Marker): View {
        ...
        schedule.text = data.hotelFacility
